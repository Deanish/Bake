	...
	<div class="col-md-12" style="padding-top: 10px;">
	    <div class="panel panel-default">
			<div class="panel-heading text-center">
				<h3 class="panel-title text-center">Applied Details</h3>
			</div>
			<br />
			<?php if ((AuthComponent::user('role') == 1) || (AuthComponent::user('role') == 3)): ?>
			...
			<?php if ((AuthComponent::user('role') == 2) || (AuthComponent::user('role') == 3)): ?>
				<table width="100%" border="0">
					<tr>
					...
					<?php foreach ($interests as $interest): ?>
						<?php if((($interest['Interest']['post_id']) == ($interest['Post']['id'])) && (($interest['Post']['user_id']) == AuthComponent::user('id'))): ?>					
							<tr>
								<td class="text-center"><?php echo h($interest['Post']['title']); ?></td>
								<td class="text-center"><?php echo h($interest['Post']['modified']); ?></td>
